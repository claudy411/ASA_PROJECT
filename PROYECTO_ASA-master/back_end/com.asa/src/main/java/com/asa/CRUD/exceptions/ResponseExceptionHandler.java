package com.asa.CRUD.exceptions;
...
public class ResponseExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		String mensaje = ex.getBindingResult() // devuelve un array de errores
				.getAllErrors()// se obtienen todos los errores
				.stream()// los pasa a un stream
				.map(errorRecibido -> {// cada error se separa del siguiente mediante comas
					return errorRecibido.getDefaultMessage().concat(",");
				}).collect(Collectors.joining());// los convierte a tipo de dato String
